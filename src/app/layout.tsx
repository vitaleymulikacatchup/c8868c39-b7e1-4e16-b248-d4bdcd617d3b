...
export const metadata: Metadata = {
  title: "StudioX Photography | Capture Perfect Moments",
  description: "Discover StudioX's award-winning photography services and stunning visual storytelling.",
  openGraph: {
    title: "StudioX Photography",
    description: "Expert photography services for capturing perfect moments.",
    siteName: "StudioX"
  },
  twitter: {
